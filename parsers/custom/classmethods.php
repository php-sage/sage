 ...
 */
class Sage_Parsers_ClassMethods extends SageParser
{
            ...
            foreach ($reflection->getMethods() as $method) {
                ...
                if (($docBlock = $method->getDocComment())) {
                    ...
                    if (preg_match_all('/@(\w+)\s+(.*)\r?\n/m', $docBlock, $matches)) {
                        ...
                        if (isset($lines['return'])) {
                            ...
                            # and saves resources
                            $output->type = self::decodeStr($lines['return'], 'UTF-8');
                        }
                    }
                }
                ...
                if (is_string($docBlock)) {
                    ...
                    foreach (explode("\n", $docBlock) as $line) {
                        ...
                        $lines[] = self::decodeStr(trim($line), 'UTF-8');
                    }
                ...
                $fileName = SageHelper::shortenPath($method->getFileName()).':'.$method->getStartLine();
