<?php
isset($GLOBALS['_sage_settings']) or $GLOBALS['_sage_settings'] = array();
$_sageSettings = &$GLOBALS['_sage_settings'];


/** @var bool if set to false, Sage will become silent, same as Sage::enabled(false) or Sage::$enabled = false */
$_sageSettings['enabled'] = true;


/**
 * @var bool whether to display where Sage was called from
 */
$_sageSettings['displayCalledFrom'] = true;
 ...
 *
 */
$_sageSettings['fileLinkFormat'] = ini_get('xdebug.file_link_format');
 ...
 *
 */
$_sageSettings['appRootDirs'] = isset($_SERVER['DOCUMENT_ROOT'])
